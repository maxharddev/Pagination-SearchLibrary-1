<?php
	...
	require_once('/xampp/htdocs/Mock_test_1/search_library/search.php');

	require_once('/xampp/htdocs/Mock_test_1/pagination1.0/prepared_query.php');
	...
	$application_obj->Myconnection ($connection_mock_chat,"localhost","root","login_db");
	...
	{   
	    ...
	    $value=array(array('name_and_email','login_db.mock_test_tbl','name, email','null as name,id,null as email,null as phone,null as gender','id'));
	    $query_data=array();
